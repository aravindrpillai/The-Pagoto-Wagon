	...
	public function authenticate(){
		...
		if(count($resp) == 1){
			if($resp[0]["retired"] == false){
				...
				$this->session->set_userdata('aadhar_number',$resp[0]['aadhar_number']);
				...
				$this->session->set_flashdata('flash_message', 'Acess Denied : User is Retired');
				redirect("Login");
				die();
			}
		}else{
