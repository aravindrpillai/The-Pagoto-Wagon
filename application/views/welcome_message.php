...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap/bower_components/morris.js/morris.css'); ?>" >
        ...
        <ul class="nav navbar-nav">
         <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Aravind R Pillai</span>
            </a>
              ...
              <div class="pull-right box-tools">
                <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                    <i class="fa fa-bars"></i> Calendar</button>
                </div>
              </div>
            </div>
...
<script src="<?php echo base_url('assets/bootstrap/bower_components/morris.js/morris.min.js') ?>"></script>
